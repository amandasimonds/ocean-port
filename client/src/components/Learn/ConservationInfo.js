    ...
    return (
        <Col>
            ...
            <Card>
                ...
                <CardBody>
                    <div className="block">
                        <img className="imgleft" src={`${process.env.PUBLIC_URL}/assets/images/Ocean-Pollution.jpg`} alt="a picture of Ocean Pollution" />
                    ...
                    <div className="block">
                    <img className="imgright" src={`${process.env.PUBLIC_URL}/assets/images/turtlesinnet.jpg`} alt="picture of turtles stuck in a fishing net" />
                    <p>
                    So what are some things we can do to help?  There are many online resources available to help you determine what seafood options are considered sustainable.  By choosing sustainable options, we help to maintain the marine life populations.  Another way we can help is by reduing our waste, in particular, plastic. 
                        </p> 
                    </div>                  
