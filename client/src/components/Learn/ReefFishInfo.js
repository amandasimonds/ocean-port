        ...
        <Col>
            ...
            <Card>
                ...
                <CardBody>
                    ...
                    <p3>
                    <img src={`${process.env.PUBLIC_URL}/assets/images/blacktailbutteryfly.jpg`} alt="picture of a blacktailbutterfly fish" />
                    </p3>
                    <p2>
                        <br></br>
                        <br></br>
                        ...
                        <br></br>
                        <br></br>
                    Let's explore the fish that live on the reef!  These beautiful fish are native to the Red Sea and in the Mediterranean off the coast of Israel.  Adults generally live in pairs are patrol a particular territory, while the younger fish live in the coral branches and are not territorial.  They eat coral polyps and sea anemone tentacles.
                    </p2>
                    <p1>
                    ...
                    <p3>
                    <img src={`${process.env.PUBLIC_URL}/assets/images/blackwedgebutteryfish.jpg`} alt="picture of a blackwedge butterfly fish" />
                    </p3>
                    <p2>
                        <br></br>
                        <br></br>
